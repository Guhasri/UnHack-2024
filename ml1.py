...
df=pd.read_csv("D:/KLA/Final-Workshop/Dataset-0/1st/CareAreas.csv",header=None)
...
data=pd.read_csv("D:/KLA/Final-Workshop/Dataset-0/1st/metadata.csv")
...
into_csv.to_csv("D:/KLA/Final-Workshop/Dataset-0/1st/mainfields.csv",header=None)

into_csv=pd.DataFrame(subcoordinates)
into_csv.to_csv("D:/KLA/Final-Workshop/Dataset-0/1st/subfields.csv",header=None)
