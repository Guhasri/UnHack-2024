...
df=pd.read_csv("D:/KLA/Final-Workshop/Dataset-1/5th/CareAreas.csv",header=None)
...
data=pd.read_csv("D:/KLA/Final-Workshop/Dataset-1/5th/metadata.csv")
...
into_csv.to_csv("D:/KLA/Final-Workshop/Dataset-1/5th/mainfields.csv",header=None)

into_csv=pd.DataFrame(subcoordinates)
into_csv.to_csv("D:/KLA/Final-Workshop/Dataset-1/5th/subfields.csv",header=None)
