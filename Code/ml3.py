...
df=pd.read_csv("D:/KLA/Final-Workshop/Dataset-1/3rd/CareAreas.csv",header=None)
...
data=pd.read_csv("D:/KLA/Final-Workshop/Dataset-1/3rd/metadata.csv")
...
into_csv.to_csv("D:/KLA/Final-Workshop/Dataset-1/3rd/mainfields.csv",header=None)

into_csv=pd.DataFrame(subcoordinates)
into_csv.to_csv("D:/KLA/Final-Workshop/Dataset-1/3rd/subfields.csv",header=None)
